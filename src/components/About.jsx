      ...
      <div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-12">
        <div className="w-full md:w-1/2">
          <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-300">
            As a passionate graphic designer, I specialize in crafting
            captivating visual identities and user-centric designs. My expertise
            in Figma and web design principles allows me to create interfaces
            that are not only aesthetically pleasing but also highly functional.
            With a solid foundation in HTML, CSS, JavaScript, Java, and C++, I
            seamlessly integrate design with development, delivering innovative
            solutions that push the boundaries of creativity and technology.
          </p>
        </div>
